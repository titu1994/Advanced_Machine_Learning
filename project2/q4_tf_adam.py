...
with tf.Session() as sess:
    ...
    learning_rate = tf.train.exponential_decay(0.5, global_step, decay_rate=0.9, decay_steps=200, staircase=True)
    ...
    saver.save(sess, 'models/crf_adam.ckpt', global_step)
